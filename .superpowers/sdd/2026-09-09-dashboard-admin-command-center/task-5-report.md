...
## Commits
- *Not yet committed* — working tree holds task-5 changes on top of `b5a22db`. Recommended commit message: `feat(dashboard): rebuild wallet with hero, rail tabs, bank rail, ledger and statement exports` (files listed above).
