...
export const appConfig = {
  ...
  jwtSecret: isProduction ? failFast('JWT_SECRET', 'JWT_SECRET') : getEnvOrDefault('JWT_SECRET', 'JWT_SECRET', 'dev-jwt-secret-change-in-production'),
  ...
  fieldEncryptionKey: isProduction ? failFast('FIELD_ENCRYPTION_KEY', 'FIELD_ENCRYPTION_KEY') : getEnvOrDefault('FIELD_ENCRYPTION_KEY', 'FIELD_ENCRYPTION_KEY', 'dev-only-field-key-change-me'),
