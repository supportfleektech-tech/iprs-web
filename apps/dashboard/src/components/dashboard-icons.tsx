...
const paths: Record<DashboardIconName, string> = {
  ...
  clipboard:
    'M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2m-6 9v6',
  wallet:
    'M20 7H4a2 2 0 0 1 0-4h14v4m2 0v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5m18 0-2-2H4a2 2 0 0 0 0 4',
  ...
  users:
    'M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2m7-11a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm13 11v-2a4 4 0 0 0-3-3.9m-2-3.1a4 4 0 0 1 0 7.8',
  building:
    'M4 21V5a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v16m2 0H4m12 0h4a1 1 0 0 1 1 1v3H4v-3a1 1 0 0 1 1-1h11m4-9h-4m4 4h-4m4 4h-4',
