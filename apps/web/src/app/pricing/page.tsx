...
export const metadata: Metadata = {
  title: 'Pricing',
  description:
    'Transparent, volume-tiered pricing for all Fleek IPRS verification products. VAT exclusive.',
};
        ...
        <section className="hero-grid-bg bg-navy-900 text-white">
          <div className="mx-auto max-w-6xl px-6 py-20 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg text-slate-300">
              Pay per successful check. Volume discounts apply automatically. All prices VAT
              exclusive.
            </p>
        ...
        <section className="py-16 bg-white">
          <div className="mx-auto max-w-6xl px-6">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-center text-slate-500">
              Your per-check price drops automatically as your monthly successful verification count
              increases. Tiers reset on the 1st of each calendar month (EAT).
            </p>
              ...
              <table className="w-full min-w-[600px] text-sm">
                ...
                <tbody className="text-slate-600">
                  <tr className="border-b border-slate-100">
                    ...
                    <td>KES 1,160</td>
                    <td>
                      KES 200 <span className="text-amber-600 text-xs">(backup KES 260)</span>
                    </td>
                    <td>KES 85</td>
                    <td>KES 150</td>
                    <td>KES 300</td>
                  ...
                  <tr className="border-b border-slate-100 bg-slate-50">
                    ...
                    <td>KES 1,140</td>
                    <td>
                      KES 195 <span className="text-amber-600 text-xs">(backup KES 254)</span>
                    </td>
                    <td>KES 83</td>
                    <td>KES 147</td>
                    <td>KES 295</td>
                  ...
                  <tr className="border-b border-slate-100">
                    ...
                    <td>KES 1,115</td>
                    <td>
                      KES 190 <span className="text-amber-600 text-xs">(backup KES 248)</span>
                    </td>
                    <td>KES 80</td>
                    <td>KES 143</td>
                    <td>KES 285</td>
                  ...
                  <tr className="border-b border-slate-100 bg-slate-50">
                    ...
                    <td>KES 1,080</td>
                    <td>
                      KES 180 <span className="text-amber-600 text-xs">(backup KES 238)</span>
                    </td>
                    <td>KES 77</td>
                    <td>KES 137</td>
                    <td>KES 275</td>
                  ...
                  <tr className="border-b border-slate-100">
                    ...
                    <td>KES 1,040</td>
                    <td>
                      KES 175 <span className="text-amber-600 text-xs">(backup KES 229)</span>
                    </td>
                    <td>KES 74</td>
                    <td>KES 132</td>
                    <td>KES 265</td>
                  ...
                  <tr className="bg-slate-50">
                    ...
                    <td>KES 1,010</td>
                    <td>
                      KES 170 <span className="text-amber-600 text-xs">(backup KES 221)</span>
                    </td>
                    <td>KES 70</td>
                    <td>KES 128</td>
                    <td>KES 250</td>
            ...
            <p className="mt-4 text-xs text-slate-400 text-center">
              <strong>SPIN Score</strong> uses special bands: 1–1K: KES 130 | 1K–5K: KES 125 |
              5K–10K: KES 120 | 10K–20K: KES 115 | 20K–50K: KES 105 | 50K–100K: KES 95.
              <br />
              <strong>Scanned Statement:</strong> KES 120 + KES 4 per page.
              <br />
              All prices <strong>VAT exclusive</strong>. Backup rates apply only when explicitly
              requested after primary source failure.
            </p>
          </div>
        </section>
            ...
            <div className="mt-12 grid gap-6 md:grid-cols-3">
              <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <p className="mt-2 text-sm text-slate-500">
                  Instant push to your Safaricom line. Enter PIN to confirm. Minimum KES 100.
                </p>
              ...
              <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <p className="mt-2 text-sm text-slate-500">
                  Manual transfer via NCBA. Wallet credited on confirmation.
                </p>
                <div className="mt-4 space-y-2 text-sm text-slate-600 font-mono">
                  <div className="rounded bg-slate-50 p-3">
                    <strong>Bank:</strong> NCBA Bank Kenya
                  </div>
                  <div className="rounded bg-slate-50 p-3">
                    <strong>Branch:</strong> Uphill
                  </div>
                  <div className="rounded bg-slate-50 p-3">
                    <strong>Account:</strong> 8402250011
                  </div>
                  <div className="rounded bg-slate-50 p-3">
                    <strong>Name:</strong> SPIN MOBILE LIMITED
                  </div>
                  <div className="rounded bg-slate-50 p-3">
                    <strong>Paybill:</strong> 880100
                  </div>
                  <div className="rounded bg-slate-50 p-3">
                    <strong>Account:</strong> 8402250011
                  </div>
              ...
              <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <p className="mt-2 text-sm text-slate-500">
                  Request an invoice from Fleektech. Minimum KES 1,000. Credited after admin
                  approval.
                </p>
                <ul className="mt-4 space-y-2 text-sm text-slate-600">
