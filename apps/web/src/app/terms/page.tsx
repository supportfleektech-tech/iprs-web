      ...
      <main className="mx-auto max-w-3xl px-6 py-20">
        ...
        <div className="mt-8 space-y-6 leading-relaxed text-slate-600">
          <section>
            ...
            <p>
              Fleek IPRS provides identity verification services aggregating public and licensed data
              sources. Results must be used in compliance with applicable law, including the Kenya Data
              Protection Act 2019.
            </p>
          </section>
          <section>
            ...
            <p>
              You may only submit verifications for individuals who have given consent, in connection
              with legitimate business purposes such as KYC, credit assessment or fraud prevention.
              Reselling raw data is prohibited.
            </p>
          </section>
          <section>
            <h2 className="mb-2 text-lg font-semibold text-slate-900">3. Billing</h2>
            <p>
              Successful verifications are billed against your wallet balance at the prices shown in your
              console. Inconclusive lookups are not billed.
            </p>
          </section>
          <section>
