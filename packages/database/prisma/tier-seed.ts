...
const TIERS: Tier[] = [
  ...
  ...['drivers_license_verification'].flatMap((type) => [
    ...
    },
    {
      ...
      backupPriceMinor: 25400,
    },
    {
      productType: type as VerificationType,
      minVolume: 2501,
      maxVolume: 5000,
      unitPriceMinor: 19000,
      backupPriceMinor: 24800,
    },
    {
      productType: type as VerificationType,
      minVolume: 5001,
  ...
  {
    productType: 'creditinfo_score_only' as VerificationType,
    minVolume: 0,
    maxVolume: null,
    unitPriceMinor: 5000,
    backupPriceMinor: null,
  ...
  {
    productType: 'creditinfo_comprehensive' as VerificationType,
    minVolume: 0,
    maxVolume: null,
  ...
  {
    productType: 'creditinfo_crb_status' as VerificationType,
    minVolume: 0,
    maxVolume: null,
  ...
  {
    productType: 'scanned_statement' as VerificationType,
    minVolume: 0,
    maxVolume: null,
    unitPriceMinor: 12000,
    backupPriceMinor: null,
